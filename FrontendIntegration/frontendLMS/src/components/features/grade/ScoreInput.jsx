      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <section className="mb-5 rounded-lg border border-slate-200 bg-white px-4 py-4 shadow-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="w-full max-w-xs space-y-1">
              <label className="text-[0.75rem] text-slate-600">강의 선택</label>
              <select
        ...
        <section className="mb-5 rounded-lg border border-slate-200 bg-white px-4 py-4 shadow-sm">
          ...
          <p className="mt-1 text-xs text-slate-500">
            각 항목별 반영 비율입니다. 실제 점수는 반영 비율을 고려하여 계산할
            수 있습니다.
          </p>
        ...
        <section className="rounded-lg border border-slate-200 bg-white px-4 py-4 shadow-sm">
          ...
          <p className="mt-1 text-xs text-slate-500">
            출석, 과제, 중간/기말 점수와 총점, 등급 및 메모를 확인할 수
            있습니다. (현재는 읽기 전용 더미 데이터입니다.)
          </p>
            ...
            <table className="min-w-full border-collapse text-[0.8rem]">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50 text-left text-slate-600">
                  ...
                  <th className="px-2 py-2 text-center">
                    중간 (/{evaluationPolicy.midterm})
                  </th>
                  <th className="px-2 py-2 text-center">
                    기말 (/{evaluationPolicy.final})
                  </th>
