    ...
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 py-8">
        ...
        <header className="mb-6 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-slate-800">강의 관리</h1>
            <p className="mt-1 text-sm text-slate-500">
              개설 강의 조회, 학기별/학과별 필터, 수강 정원 및 상태를
              관리합니다.
            </p>
          </div>
        ...
        <section className="rounded-lg border border-slate-200 bg-white px-4 py-4 shadow-sm">
          <h2 className="text-sm font-semibold text-slate-800">강의 목록</h2>
          <p className="mt-1 text-xs text-slate-500">
            필터 조건에 따라 강의 목록이 표시됩니다. 강의 상세, 수강현황, 수정
            등은 아래 액션 버튼으로 이동합니다.
          </p>
        ...
        <p className="mt-4 text-[0.75rem] text-slate-400">
          ...
          API를 연동하여 로그인한 사용자 권한(관리자/교수)에 따라 목록을
          불러와야 합니다.
        </p>
      </div>
    </div>
