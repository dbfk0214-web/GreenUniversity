        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
          ...
          <div className="space-y-3">
            <DashboardButton
              ...
              onClick={() =>
                setActiveModal(modalTypes.ATTENDANCE_CHECK)
              }
            />
            <DashboardButton
              label="출결 현황"
              ...
              onClick={() =>
                setActiveModal(modalTypes.ATTENDANCE_STATUS)
              }
            />
          </div>
        </section>
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
          ...
          <div className="space-y-3">
            <DashboardButton
              ...
              onClick={() =>
                setActiveModal(modalTypes.EXAM_SCHEDULE)
              }
            />
            <DashboardButton
              label="시험 공지"
              ...
              onClick={() =>
                setActiveModal(modalTypes.EXAM_NOTICE)
              }
            />
          </div>
        </section>
