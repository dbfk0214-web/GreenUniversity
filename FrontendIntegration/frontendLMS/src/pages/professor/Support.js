      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
          ...
          <div className="space-y-3">
            <DashboardButton
              ...
              onClick={() =>
                setActiveModal(modalTypes.SUPPORT_REQUEST)
              }
            />
            <DashboardButton
              label="IT 지원 요청"
              ...
              onClick={() =>
                setActiveModal(modalTypes.IT_SUPPORT)
              }
            />
          </div>
        </section>
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
          ...
          <div className="space-y-3">
            <DashboardButton
              ...
              onClick={() =>
                setActiveModal(modalTypes.FACILITY_SUPPORT)
              }
            />
            <DashboardButton
              label="요청 처리 현황"
              ...
              onClick={() =>
                setActiveModal(modalTypes.REQUEST_STATUS)
              }
            />
          </div>
        </section>
        ...
        <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
          ...
          <DashboardButton
            ...
            onClick={() =>
              setActiveModal(modalTypes.SUPPORT_NOTICE)
            }
          />
        </section>
      </div>
    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/25">
      <div className="w-full max-w-[80%] rounded-2xl bg-white p-6 shadow-xl ring-1 ring-slate-200">
        ...
        <div className="rounded-xl border border-dashed border-slate-200 bg-slate-50 p-4 text-xs text-slate-500">
          ...
          <p>요청 입력 또는 조회 UI가 이 영역에 표시됩니다.</p>
