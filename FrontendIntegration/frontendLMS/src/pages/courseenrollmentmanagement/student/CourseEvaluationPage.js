...
export default function CourseEvaluationPage() {
  ...
  const courses = [
    { id: 1, title: "웹 프로그래밍", professor: "홍길동", semester: "2025-1학기" },
    ...
    { id: 5, title: "모바일 프로그래밍", professor: "신사임당", semester: "2025-1학기" },
    { id: 6, title: "알고리즘 기초", professor: "정약용", semester: "2025-1학기" },
    { id: 7, title: "데이터베이스 설계", professor: "안중근", semester: "2025-1학기" },
    { id: 8, title: "인공지능 개론", professor: "장영실", semester: "2025-1학기" },
    { id: 9, title: "소프트웨어 공학", professor: "유재석", semester: "2025-1학기" },
  ];
