...
const CourseManagement = () => {
  ...
  const dummyCourses = [
    { id: 101, title: "웹 프로그래밍", professor: "홍길동", date: "2025-01-10" },
    ...
    { id: 105, title: "모바일 프로그래밍", professor: "신사임당", date: "2025-01-22" },
    { id: 106, title: "알고리즘 기초", professor: "정약용", date: "2025-01-25" },
    { id: 107, title: "데이터베이스 설계", professor: "안중근", date: "2025-01-28" },
  ];
  ...
  const userCourseDetails = {
    ...
    102: {
      ...
      notices: [
        { id: 1, title: "1주차 예제 코드 업로드", date: "2025-01-15" },
      ],
      gradeSummary: {
        assignments: 20,
        midterm: 0,
