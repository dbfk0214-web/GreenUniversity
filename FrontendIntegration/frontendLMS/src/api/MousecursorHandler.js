...
export const menus = {
  ...
  PROFESSOR: [
    {
      label: "강의/수업관리(교수)",
      to: "/CourseEnrollmentManagement/professor/courses",
      children: [
        {
          label: "강의 관리",
          to: "/CourseEnrollmentManagement/professor/lecture management",
        },
        {
          label: "수업 운영",
          to: "/CourseEnrollmentManagement/professor/class management",
          children: [
            {
              label: "휴강 알림",
